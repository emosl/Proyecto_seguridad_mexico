...
} from "./chunk-GC2KFKEB.js";
import {
  esm_default
} from "./chunk-Y6FEV26V.js";
import {
  require_PowerSettingsNew
} from "./chunk-RNH5VZU5.js";
import {
...
var DashboardMenuItem = function(props) {
  var basename = useBasename();
  var _a13 = props.leftIcon, leftIcon = _a13 === void 0 ? import_react15.default.createElement(import_Dashboard.default, null) : _a13, _b = props.to, to = _b === void 0 ? "".concat(basename, "/") : _b, _c = props.primaryText, primaryText = _c === void 0 ? "ra.page.dashboard" : _c, rest = __rest12(props, ["leftIcon", "to", "primaryText"]);
...
var InspectorButton = React28.forwardRef(function(_a13, ref) {
...
var Menu = function(props) {
  ...
  return React36.createElement(Root7, __assign21({ className: clsx_m_default((_a13 = {}, _a13[MenuClasses.open] = open, _a13[MenuClasses.closed] = !open, _a13), className) }, rest), children);
};
Menu.propTypes = {
...
var LinearProgress = function(_a13) {
  var _b = _a13.timeout, timeout = _b === void 0 ? 1e3 : _b, props = __rest21(_a13, ["timeout"]);
...
var sanitizeRestProps2 = function(_a13) {
  var staticContext = _a13.staticContext, history = _a13.history, location = _a13.location, match = _a13.match, rest = __rest24(_a13, ["staticContext", "history", "location", "match"]);
  return rest;
};
NotFound.propTypes = {
...
var BulkDeleteWithConfirmButton = function(props) {
  var _a13 = props.confirmTitle, confirmTitle = _a13 === void 0 ? "ra.message.bulk_delete_title" : _a13, _b = props.confirmContent, confirmContent = _b === void 0 ? "ra.message.bulk_delete_content" : _b, _c = props.icon, icon = _c === void 0 ? defaultIcon6 : _c, _d = props.label, label = _d === void 0 ? "ra.action.delete" : _d, _e = props.mutationMode, mutationMode = _e === void 0 ? "pessimistic" : _e, _f = props.mutationOptions, mutationOptions = _f === void 0 ? {} : _f, onClick = props.onClick, rest = __rest26(props, ["confirmTitle", "confirmContent", "icon", "label", "mutationMode", "mutationOptions", "onClick"]);
...
var BulkDeleteWithUndoButton = function(props) {
  var _a13 = props.label, label = _a13 === void 0 ? "ra.action.delete" : _a13, _b = props.icon, icon = _b === void 0 ? defaultIcon7 : _b, onClick = props.onClick, _c = props.mutationOptions, mutationOptions = _c === void 0 ? {} : _c, rest = __rest27(props, ["label", "icon", "onClick", "mutationOptions"]);
...
var BulkExportButton = function(props) {
  var onClick = props.onClick, _a13 = props.label, label = _a13 === void 0 ? "ra.action.export" : _a13, _b = props.icon, icon = _b === void 0 ? defaultIcon8 : _b, customExporter = props.exporter, meta = props.meta, rest = __rest29(props, ["onClick", "label", "icon", "exporter", "meta"]);
...
var DeleteWithConfirmButton = function(props) {
  var className = props.className, _a13 = props.confirmTitle, confirmTitle = _a13 === void 0 ? "ra.message.delete_title" : _a13, _b = props.confirmContent, confirmContent = _b === void 0 ? "ra.message.delete_content" : _b, _c = props.icon, icon = _c === void 0 ? defaultIcon12 : _c, _d = props.label, label = _d === void 0 ? "ra.action.delete" : _d, _e = props.mutationMode, mutationMode = _e === void 0 ? "pessimistic" : _e, onClick = props.onClick, _f = props.redirect, redirect = _f === void 0 ? "list" : _f, _g = props.translateOptions, translateOptions = _g === void 0 ? {} : _g, mutationOptions = props.mutationOptions, _h = props.color, color = _h === void 0 ? "error" : _h, rest = __rest34(props, ["className", "confirmTitle", "confirmContent", "icon", "label", "mutationMode", "onClick", "redirect", "translateOptions", "mutationOptions", "color"]);
  var translate = useTranslate();
  var record = useRecordContext(props);
  var resource = useResourceContext(props);
...
var EditButton = function(props) {
  var _a13 = props.icon, icon = _a13 === void 0 ? defaultIcon13 : _a13, _b = props.label, label = _b === void 0 ? "ra.action.edit" : _b, _c = props.scrollToTop, scrollToTop = _c === void 0 ? true : _c, className = props.className, rest = __rest36(props, ["icon", "label", "scrollToTop", "className"]);
  var resource = useResourceContext(props);
  var record = useRecordContext(props);
  var createPath = useCreatePath();
  if (!record)
...
var ExportButton = function(props) {
  var _a13 = props.maxResults, maxResults = _a13 === void 0 ? 1e3 : _a13, onClick = props.onClick, _b = props.label, label = _b === void 0 ? "ra.action.export" : _b, _c = props.icon, icon = _c === void 0 ? defaultIcon14 : _c, customExporter = props.exporter, meta = props.meta, rest = __rest37(props, ["maxResults", "onClick", "label", "icon", "exporter", "meta"]);
...
var ListButton = function(props) {
  var _a13 = props.icon, icon = _a13 === void 0 ? defaultIcon15 : _a13, _b = props.label, label = _b === void 0 ? "ra.action.list" : _b, resourceProp = props.resource, _c = props.scrollToTop, scrollToTop = _c === void 0 ? true : _c, rest = __rest39(props, ["icon", "label", "resource", "scrollToTop"]);
  var resource = useResourceContext(props);
  var createPath = useCreatePath();
...
var RefreshButton = function(props) {
  var _a13 = props.label, label = _a13 === void 0 ? "ra.action.refresh" : _a13, _b = props.icon, icon = _b === void 0 ? defaultIcon16 : _b, onClick = props.onClick, rest = __rest40(props, ["label", "icon", "onClick"]);
  var refresh = useRefresh();
...
var RefreshIconButton = function(props) {
  var _a13 = props.label, label = _a13 === void 0 ? "ra.action.refresh" : _a13, _b = props.icon, icon = _b === void 0 ? defaultIcon17 : _b, onClick = props.onClick, className = props.className, rest = __rest41(props, ["label", "icon", "onClick", "className"]);
  var refresh = useRefresh();
  var translate = useTranslate();
...
var UpdateWithConfirmButton = function(props) {
  ...
  var translate = useTranslate();
  var resource = useResourceContext(props);
  var _a13 = (0, import_react36.useState)(false), isOpen = _a13[0], setOpen = _a13[1];
  var record = useRecordContext(props);
...
var UpdateWithUndoButton = function(props) {
  ...
  var resource = useResourceContext(props);
  var refresh = useRefresh();
  var data = props.data, _a13 = props.label, label = _a13 === void 0 ? "ra.action.update" : _a13, _b = props.icon, icon = _b === void 0 ? defaultIcon20 : _b, onClick = props.onClick, _c = props.mutationOptions, mutationOptions = _c === void 0 ? {} : _c, rest = __rest44(props, ["data", "label", "icon", "onClick", "mutationOptions"]);
...
var SimpleFormIterator = function(props) {
  var _a13 = props.addButton, addButton = _a13 === void 0 ? React77.createElement(AddItemButton, null) : _a13, _b = props.removeButton, removeButton = _b === void 0 ? React77.createElement(RemoveItemButton, null) : _b, _c = props.reOrderButtons, reOrderButtons = _c === void 0 ? React77.createElement(ReOrderButtons, null) : _c, children = props.children, className = props.className, resource = props.resource, source = props.source, disabled = props.disabled, _d = props.disableAdd, disableAdd = _d === void 0 ? false : _d, disableClear = props.disableClear, _e = props.disableRemove, disableRemove = _e === void 0 ? false : _e, disableReordering = props.disableReordering, inline = props.inline, _f = props.getItemLabel, getItemLabel = _f === void 0 ? false : _f, fullWidth = props.fullWidth, sx = props.sx;
...
var BooleanInput = function(props) {
  var className = props.className, _a13 = props.row, row = _a13 === void 0 ? false : _a13, _b = props.defaultValue, defaultValue = _b === void 0 ? false : _b, format = props.format, label = props.label, fullWidth = props.fullWidth, helperText = props.helperText, onBlur = props.onBlur, onChange = props.onChange, onFocus = props.onFocus, disabled = props.disabled, parse = props.parse, resource = props.resource, source = props.source, validate = props.validate, _c = props.options, options = _c === void 0 ? defaultOptions : _c, sx = props.sx, rest = __rest54(props, ["className", "row", "defaultValue", "format", "label", "fullWidth", "helperText", "onBlur", "onChange", "onFocus", "disabled", "parse", "resource", "source", "validate", "options", "sx"]);
...
var CheckboxGroupInput = function(props) {
  ...
  return React83.createElement(
    ...
    React83.createElement(FormGroup_default, { row }, allChoices === null || allChoices === void 0 ? void 0 : allChoices.map(function(choice, index) {
...
var DatagridCell = React84.forwardRef(function(_a13, ref) {
...
var DatagridRow = import_react54.default.forwardRef(function(props, ref) {
  ...
  return import_react54.default.createElement(
    ...
    import_react54.default.createElement(
      TableRow_default,
      __assign63({ ref, className: clsx_m_default(className, (_a13 = {}, _a13[DatagridClasses.expandable] = expandable, _a13[DatagridClasses.selectable] = selectable, _a13[DatagridClasses.clickableRow] = typeof rowClick === "function" ? true : rowClick, _a13)), key: id, style, hover, onClick: handleClick2 }, rest),
...
var DatagridWithPreferences = function(_a13) {
  var children = _a13.children, props = __rest64(_a13, ["children"]);
...
var SelectColumnsButton = function(props) {
  ...
  var resource = useResourceContext(props);
  var finalPreferenceKey = preferenceKey || "".concat(resource, ".datagrid");
  var _a13 = React99.useState(null), anchorEl = _a13[0], setAnchorEl = _a13[1];
  var _b = useStore("preferences.".concat(finalPreferenceKey, ".availableColumns"), []), availableColumns = _b[0], setAvailableColumns = _b[1];
...
var FilterButton = function(props) {
  ...
  var handleShow = (0, import_react67.useCallback)(function(_a14) {
...
var AddSavedQueryIconButton = function(props) {
  var _a13 = (0, import_react71.useState)(false), open = _a13[0], setOpen = _a13[1];
  var handleOpen = function() {
    setOpen(true);
  };
  var handleClose = function() {
...
var RemoveSavedQueryIconButton = function(props) {
  var _a13 = (0, import_react72.useState)(false), confirmationOpen = _a13[0], setConfirmationOpen = _a13[1];
...
var SavedQueriesList = function(_a13) {
  var _b = _a13.icon, icon = _b === void 0 ? defaultIcon21 : _b;
  var translate = useTranslate();
...
var PaginationActions = (0, import_react75.memo)(function(props) {
  var page = props.page, rowsPerPage = props.rowsPerPage, count = props.count, onPageChange = props.onPageChange, _a13 = props.size, size = _a13 === void 0 ? "small" : _a13, className = props.className, rest = __rest71(props, ["page", "rowsPerPage", "count", "onPageChange", "size", "className"]);
  var translate = useTranslate();
...
var Pagination = (0, import_react76.memo)(function(props) {
  ...
  var labelDisplayedRows = (0, import_react76.useCallback)(function(_a14) {
...
var DatagridInput = function(props) {
  ...
  return React119.createElement(
    ...
    React119.createElement(
      ...
      React119.createElement(InputHelperText, { touched: fieldState.isTouched || formState.isSubmitted || fetchError, error: ((_a13 = fieldState.error) === null || _a13 === void 0 ? void 0 : _a13.message) || (fetchError === null || fetchError === void 0 ? void 0 : fetchError.message) })
    )
  );
};
...
var DateTimeInput = function(_a13) {
  var className = _a13.className, defaultValue = _a13.defaultValue, _b = _a13.format, format = _b === void 0 ? formatDateTime : _b, label = _a13.label, helperText = _a13.helperText, margin = _a13.margin, onBlur = _a13.onBlur, onChange = _a13.onChange, source = _a13.source, resource = _a13.resource, _c = _a13.parse, parse = _c === void 0 ? parseDateTime : _c, validate = _a13.validate, variant = _a13.variant, rest = __rest75(_a13, ["className", "defaultValue", "format", "label", "helperText", "margin", "onBlur", "onChange", "source", "resource", "parse", "validate", "variant"]);
...
var TimeInput = function(_a13) {
  var className = _a13.className, defaultValue = _a13.defaultValue, _b = _a13.format, format = _b === void 0 ? formatTime : _b, label = _a13.label, helperText = _a13.helperText, margin = _a13.margin, onBlur = _a13.onBlur, onChange = _a13.onChange, source = _a13.source, resource = _a13.resource, _c = _a13.parse, parse = _c === void 0 ? parseTime : _c, validate = _a13.validate, variant = _a13.variant, rest = __rest76(_a13, ["className", "defaultValue", "format", "label", "helperText", "margin", "onBlur", "onChange", "source", "resource", "parse", "validate", "variant"]);
...
var FileInputPreview = function(props) {
  var children = props.children, className = props.className, onRemove = props.onRemove, file = props.file, _a13 = props.removeIcon, RemoveIcon2 = _a13 === void 0 ? import_RemoveCircle.default : _a13, rest = __rest77(props, ["children", "className", "onRemove", "file", "removeIcon"]);
  var translate = useTranslate();
...
var FileInput = function(props) {
  var accept = props.accept, children = props.children, className = props.className, format = props.format, helperText = props.helperText, inputPropsOptions = props.inputProps, maxSize = props.maxSize, minSize = props.minSize, _a13 = props.multiple, multiple = _a13 === void 0 ? false : _a13, label = props.label, _b = props.labelMultiple, labelMultiple = _b === void 0 ? "ra.input.file.upload_several" : _b, _c = props.labelSingle, labelSingle = _c === void 0 ? "ra.input.file.upload_single" : _c, _d = props.options, options = _d === void 0 ? {} : _d, onRemoveProp = props.onRemove, parse = props.parse, placeholder = props.placeholder, removeIcon = props.removeIcon, resource = props.resource, source = props.source, validate = props.validate, validateFileRemoval = props.validateFileRemoval, rest = __rest78(props, ["accept", "children", "className", "format", "helperText", "inputProps", "maxSize", "minSize", "multiple", "label", "labelMultiple", "labelSingle", "options", "onRemove", "parse", "placeholder", "removeIcon", "resource", "source", "validate", "validateFileRemoval"]);
    ...
    if (!resettable) {
      ...
      return React127.createElement(
        ...
        React127.createElement(
          ...
          React127.createElement(import_Clear.default, { className: clsx_m_default(clearIcon, (_a14 = {}, _a14[visibleClearIcon] = clearAlwaysVisible || value, _a14)) })
        )
      );
    }
  };
...
var NumberInput = function(_a13) {
  ...
  return React130.createElement(TextField_default, __assign88({ id }, fieldWithoutRef, {
    inputRef: ref,
...
var TextInput = function(props) {
  ...
  var _a13 = useInput(__assign89({ defaultValue, format, parse, resource, source, type: "text", validate, onBlur, onChange }, rest)), field = _a13.field, _b = _a13.fieldState, error = _b.error, invalid = _b.invalid, isTouched = _b.isTouched, isSubmitted = _a13.formState.isSubmitted, id = _a13.id, isRequired2 = _a13.isRequired;
  var renderHelperText = helperText !== false || (isTouched || isSubmitted) && invalid;
...
var ReferenceArrayInput = function(props) {
  var _a13 = props.children, children = _a13 === void 0 ? defaultChildren2 : _a13, reference = props.reference, sort = props.sort, _b = props.filter, filter = _b === void 0 ? defaultFilter : _b;
...
var ReferenceError = function(_a13) {
...
var ReferenceInput = function(props) {
  var _a13 = props.children, children = _a13 === void 0 ? defaultChildren3 : _a13, reference = props.reference, _b = props.sort, sort = _b === void 0 ? { field: "id", order: "DESC" } : _b, _c = props.filter, filter = _c === void 0 ? {} : _c;
...
var StyledTab = styled_default(Tab_default, { name: PREFIX60 })(function(_a13) {
  var _b;
  var theme = _a13.theme;
...
var StyledAppBar2 = styled_default(AppBar_default, { name: PREFIX61 })(function(_a13) {
  var _b;
  var theme = _a13.theme;
...
var Root22 = styled_default(Stack_default, { name: PREFIX62 })(function(_a13) {
  var _b;
  var theme = _a13.theme;
...
var Login = function(props) {
  var _a13 = props.children, children = _a13 === void 0 ? defaultLoginForm : _a13, backgroundImage = props.backgroundImage, rest = __rest90(props, ["children", "backgroundImage"]);
...
var Toolbar = function(props) {
  ...
  return React153.createElement(StyledToolbar2, __assign109({ className: clsx_m_default((_a13 = {}, _a13[ToolbarClasses.mobileToolbar] = isXs, _a13[ToolbarClasses.desktopToolbar] = !isXs, _a13), className), role: "toolbar" }, rest), import_react90.Children.count(children) === 0 ? React153.createElement(
    "div",
...
var sanitizeRestProps25 = function(_a13) {
  var classes2 = _a13.classes, ref = _a13.ref, margin = _a13.margin, rest = __rest101(_a13, ["classes", "ref", "margin"]);
  return rest;
};
...
var SimpleForm = function(props) {
  var children = props.children, className = props.className, _a13 = props.component, Component2 = _a13 === void 0 ? DefaultComponent2 : _a13, sx = props.sx, _b = props.toolbar, toolbar = _b === void 0 ? DefaultToolbar3 : _b, rest = __rest103(props, ["children", "className", "component", "sx", "toolbar"]);
...
var SimpleFormWithPreferences = function(_a13) {
  var children = _a13.children, props = __rest104(_a13, ["children"]);
...
var editFieldTypes = {
  ...
  array: {
    ...
    component: function(_a13) {
      var children = _a13.children, props = __rest105(_a13, ["children"]);
...
var EditViewGuesser = function(props) {
  ...
  var _a13 = (0, import_react94.useState)(null), child = _a13[0], setChild = _a13[1];
  ...
  return React163.createElement(EditView, __assign118({}, rest), child);
};
...
var BooleanFieldImpl = function(props) {
  ...
  if (looseValue || value === false || value === true) {
    return React168.createElement(
      ...
      React168.createElement(Tooltip_default, { title: translate(ariaLabel, { _: ariaLabel }) }, isTruthyValue ? TrueIcon ? React168.createElement(TrueIcon, { "data-testid": "true", fontSize: "small", className: classes.trueIcon }) : React168.createElement(React168.Fragment, null) : FalseIcon ? React168.createElement(FalseIcon, { "data-testid": "false", fontSize: "small", className: classes.falseIcon }) : React168.createElement(React168.Fragment, null))
    );
  }
...
var NumberFieldImpl = function(props) {
  var className = props.className, emptyText = props.emptyText, source = props.source, locales = props.locales, options = props.options, textAlign = props.textAlign, _a13 = props.transform, transform = _a13 === void 0 ? defaultTransform2 : _a13, rest = __rest117(props, ["className", "emptyText", "source", "locales", "options", "textAlign", "transform"]);
  var record = useRecordContext(props);
  var translate = useTranslate();
  if (!record) {
    return null;
...
var SingleFieldList = function(props) {
  var className = props.className, children = props.children, _a13 = props.linkType, linkType = _a13 === void 0 ? "edit" : _a13, _b = props.component, Component2 = _b === void 0 ? Root31 : _b, rest = __rest119(props, ["className", "children", "linkType", "component"]);
...
var NonEmptyReferenceField = function(_a13) {
  var children = _a13.children, id = _a13.id, reference = _a13.reference, queryOptions = _a13.queryOptions, link = _a13.link, props = __rest120(_a13, ["children", "id", "reference", "queryOptions", "link"]);
...
var ReferenceOneField = function(props) {
  var children = props.children, reference = props.reference, _a13 = props.source, source = _a13 === void 0 ? "id" : _a13, target = props.target, emptyText = props.emptyText, sort = props.sort, filter = props.filter, _b = props.link, link = _b === void 0 ? false : _b, queryOptions = props.queryOptions;
  var record = useRecordContext(props);
  var createPath = useCreatePath();
  var translate = useTranslate();
...
var TranslatableFieldsTabContent = function(props) {
  var children = props.children, _a13 = props.groupKey, groupKey = _a13 === void 0 ? "" : _a13, locale = props.locale, record = props.record, resource = props.resource, className = props.className, other = __rest126(props, ["children", "groupKey", "locale", "record", "resource", "className"]);
...
var TranslatableFields = function(props) {
  var defaultLocale = props.defaultLocale, locales = props.locales, _a13 = props.groupKey, groupKey = _a13 === void 0 ? "" : _a13, _b = props.selector, selector = _b === void 0 ? React189.createElement(TranslatableFieldsTabs, { groupKey }) : _b, children = props.children, resource = props.resource, className = props.className;
  var record = useRecordContext(props);
  var context = useTranslatable({ defaultLocale, locales });
...
var SimpleShowLayout = function(props) {
  var className = props.className, children = props.children, divider = props.divider, _a13 = props.spacing, spacing = _a13 === void 0 ? 1 : _a13, rest = __rest128(props, ["className", "children", "divider", "spacing"]);
  var record = useRecordContext(props);
  if (!record) {
    return null;
  }
...
var showFieldTypes = {
  ...
  array: {
    // eslint-disable-next-line react/display-name
    component: function(_a13) {
      var children = _a13.children, props = __rest129(_a13, ["children"]);
...
var ShowViewGuesser = function(props) {
  ...
  var _a13 = (0, import_react105.useState)(null), child = _a13[0], setChild = _a13[1];
  ...
  return React194.createElement(ShowView, __assign144({}, rest), child);
};
...
var TabbedShowLayoutTabs = function(_a13) {
  var children = _a13.children, syncWithLocation = _a13.syncWithLocation, value = _a13.value, rest = __rest131(_a13, ["children", "syncWithLocation", "value"]);
  var params = useParams();
  var tabValue = params["*"];
...
var Tab = function(_a13) {
  var children = _a13.children, contentClassName = _a13.contentClassName, context = _a13.context, count = _a13.count, className = _a13.className, divider = _a13.divider, icon = _a13.icon, label = _a13.label, record = _a13.record, _b = _a13.spacing, spacing = _b === void 0 ? 1 : _b, _c = _a13.syncWithLocation, syncWithLocation = _c === void 0 ? true : _c, value = _a13.value, rest = __rest132(_a13, ["children", "contentClassName", "context", "count", "className", "divider", "icon", "label", "record", "spacing", "syncWithLocation", "value"]);
  var translate = useTranslate();
  var location = useLocation();
  var propsForLink = {
    component: Link,
...
var TabbedShowLayout = function(props) {
  var children = props.children, className = props.className, spacing = props.spacing, divider = props.divider, _a13 = props.syncWithLocation, syncWithLocation = _a13 === void 0 ? true : _a13, _b = props.tabs, tabs = _b === void 0 ? DefaultTabs2 : _b, value = props.value, rest = __rest133(props, ["children", "className", "spacing", "divider", "syncWithLocation", "tabs", "value"]);
  var record = useRecordContext(props);
...
var Count = function(props) {
  var filter = props.filter, sort = props.sort, link = props.link, resourceFromProps = props.resource, _a13 = props.timeout, timeout = _a13 === void 0 ? 1e3 : _a13, rest = __rest134(props, ["filter", "sort", "link", "resource", "timeout"]);
  var resource = useResourceContext(props);
  var oneSecondHasPassed = useTimeout(timeout);
  var createPath = useCreatePath();
...
var ListActions = function(props) {
  var className = props.className, filtersProp = props.filters, _ = props.hasCreate, _a13 = props.selectedIds, selectedIds = _a13 === void 0 ? defaultSelectedIds : _a13, _b = props.onUnselectItems, onUnselectItems = _b === void 0 ? defaultOnUnselectItems : _b, rest = __rest136(props, ["className", "filters", "hasCreate", "selectedIds", "onUnselectItems"]);
...
var InfiniteList = function(_a13) {
  var debounce2 = _a13.debounce, disableAuthentication = _a13.disableAuthentication, disableSyncWithLocation = _a13.disableSyncWithLocation, exporter = _a13.exporter, _b = _a13.filter, filter = _b === void 0 ? defaultFilter3 : _b, filterDefaultValues = _a13.filterDefaultValues, _c = _a13.pagination, pagination = _c === void 0 ? defaultPagination3 : _c, _d = _a13.perPage, perPage = _d === void 0 ? 10 : _d, queryOptions = _a13.queryOptions, resource = _a13.resource, sort = _a13.sort, storeKey = _a13.storeKey, rest = __rest138(_a13, ["debounce", "disableAuthentication", "disableSyncWithLocation", "exporter", "filter", "filterDefaultValues", "pagination", "perPage", "queryOptions", "resource", "sort", "storeKey"]);
...
var List = function(_a13) {
  var debounce2 = _a13.debounce, disableAuthentication = _a13.disableAuthentication, disableSyncWithLocation = _a13.disableSyncWithLocation, exporter = _a13.exporter, _b = _a13.filter, filter = _b === void 0 ? defaultFilter4 : _b, filterDefaultValues = _a13.filterDefaultValues, _c = _a13.perPage, perPage = _c === void 0 ? 10 : _c, queryOptions = _a13.queryOptions, resource = _a13.resource, sort = _a13.sort, storeKey = _a13.storeKey, rest = __rest139(_a13, ["debounce", "disableAuthentication", "disableSyncWithLocation", "exporter", "filter", "filterDefaultValues", "perPage", "queryOptions", "resource", "sort", "storeKey"]);
...
var listFieldTypes = {
  ...
  array: {
    // eslint-disable-next-line react/display-name
    component: function(_a13) {
      var children = _a13.children, props = __rest140(_a13, ["children"]);
...
var ListViewGuesser = function(props) {
  ...
  return React206.createElement(ListView, __assign155({}, rest), child);
};
...
var AdminContext = function(props) {
  var theme = props.theme, _a13 = props.lightTheme, lightTheme = _a13 === void 0 ? defaultLightTheme : _a13, darkTheme = props.darkTheme, defaultTheme2 = props.defaultTheme, children = props.children, rest = __rest146(props, ["theme", "lightTheme", "darkTheme", "defaultTheme", "children"]);
